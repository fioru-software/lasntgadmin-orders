...
/* harmony export */   CoursePrerequisitesMetCheckbox: () => (/* binding */ CoursePrerequisitesMetCheckbox),
...
/* harmony export */   TelInput: () => (/* binding */ TelInput),
...
const SelectInput = props => {
  const selectInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_3__.isNil)(props.value)) {
  ...
  }, !props.value && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    disabled: true,
    value: ""
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('- Select -', 'lasntgadmin')), props.children), props?.disabled && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    ref: hiddenInput,
    type: "hidden",
    name: props.name,
    defaultValue: props?.value
...
const TrueFalse = props => {
  const checkInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_3__.isBoolean)(props.checked)) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    ...
    onChange: handleChange
  }), props?.disabled && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    ref: hiddenInput,
    type: "hidden",
    name: props.name,
...
const CoursePrerequisitesMetCheckbox = props => {
  ...
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_3__.isNil)(props.checked)) {
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_3__.isArray)(props.checked)) {
...
const TextInput = props => {
  const textInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_3__.isNil)(props.value)) {
...
const DateInput = props => {
  const dateInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_3__.isNil)(props?.value)) {
      let dt = luxon__WEBPACK_IMPORTED_MODULE_2__.DateTime.fromISO(props.value);
      if (dt.invalid) {
        dt = luxon__WEBPACK_IMPORTED_MODULE_2__.DateTime.fromFormat(props.value, 'dd/MM/yyyy');
      }
...
const NumberInput = props => {
  const numberInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_3__.isNil)(props.value)) {
...
const TelInput = props => {
  const telInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const hiddenInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_3__.isNil)(props.value)) {
...
/* harmony export */   AttendeeFormContext: () => (/* binding */ AttendeeFormContext),
/* harmony export */   AttendeesContext: () => (/* binding */ AttendeesContext),
...
const AttendeesContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createContext)();
const AttendeeFormContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createContext)();
...
/* harmony import */ var _attendee_context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./attendee-context */ "./src/attendees-tab/attendee-context.js");
...
/* harmony import */ var _order_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../order-utils */ "./src/order-utils.js");
/* harmony import */ var _attendee_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./attendee-utils */ "./src/attendees-tab/attendee-utils.js");
/* harmony import */ var _enrolment_log_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./enrolment-log-utils */ "./src/attendees-tab/enrolment-log-utils.js");
...
const AttendeeFormFieldsetButtons = props => {
  ...
  const product = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.ProductContext);
  const attendees = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.AttendeesContext); // All attendees
  const attendee = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.AttendeeContext); // Attendee relevant to this button
  const order = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.OrderContext);
  const attendeeFormContext = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.AttendeeFormContext);
  const [isLoading, setLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [notice, setNotice] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [isRemovable, setRemovable] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)();
  const [isResetable, setResetable] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)();
  const [attendeeId, setAttendeeId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(); // attendee.id || attendeeId

  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNil)(attendee)) {
      if ((0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isAttendeeLoadedViaProps)(attendee)) {
        setAttendeeId(parseInt(attendee.ID));
      }
      if ((0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isAttendeeLoadedViaSearch)(attendee)) {
        setAttendeeId(parseInt(attendee.id));
      }
    }
  }, [attendee]);
  ...
  function isResetButtonDisabled() {
    return (0,_product_utils__WEBPACK_IMPORTED_MODULE_5__.isCourseClosed)(product.status) || !(0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isExistingAttendee)(attendee) || isLoading || attendeeFormContext.isLoading;
  }
  ...
  function isRemoveButtonDisabled() {
    return attendeeFormContext.isLoading || (0,_product_utils__WEBPACK_IMPORTED_MODULE_5__.isCourseClosed)(product.status) || isLoading || quantity < 2 || order.payment_method !== "" && !(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isGrantPaid)(order.payment_method) && !(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isPurchaseOrderPaid)(order.payment_method);
  }
  ...
  async function removeProductFromAttendee() {
    if ((0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isProductIdInAttendeeMeta)(product.id, attendee.meta)) {
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removing product from attendee meta...', 'lasntgadmin')
      });
      const removeProductFromAttendeeRequest = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.getUpdateAttendeeRequest)(order.id, attendeeId, nonce, {
        meta: {
          product_ids: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.filterProductIdFromAttendeeMeta)(product.id, attendee.meta)
        }
      });
      const removeProductFromAttendeeResponse = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()(removeProductFromAttendeeRequest);
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removed product from attendee meta.', 'lasntgadmin')
      });
    }
  }
  ...
  async function removeOrderFromAttendee() {
    if ((0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isOrderIdInAttendeeMeta)(order.id, attendee.meta)) {
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removing order from attendee meta...', 'lasntgadmin')
      });
      const removeOrderFromAttendeeRequest = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.getUpdateAttendeeRequest)(order.id, attendeeId, nonce, {
        meta: {
          order_ids: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.filterOrderIdFromAttendeeMeta)(order.id, attendee.meta)
        }
      });
      const removeOrderFromAttendeeResponse = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()(removeOrderFromAttendeeRequest);
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removed order from attendee meta.', 'lasntgadmin')
      });
    }
  }
  ...
  async function removeAttendeeFromOrder() {
    if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isAttendeeIdInOrderMeta)(attendeeId, order.meta_data)) {
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removing attendee from order meta...', 'lasntgadmin')
      });
      order.meta_data = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.filterItemFromOrderMeta)('attendee_ids', attendeeId, order.meta_data);
      const removeAttendeeFromOrderRequest = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getRemoveAttendeeFromShopOrderRequest)(order.id, attendeeId, nonce, {
        meta: {
          attendee_ids: (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.filterAttendeeIdFromOrderMeta)(attendeeId, order.meta_data)
        }
      });
      const removeAttendeeFromOrderResponse = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()(removeAttendeeFromOrderRequest);
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removed attendee from order meta.', 'lasntgadmin')
      });
    }
  }
  ...
  async function decrementOrderQuantity() {
    ...
    setNotice({
      status: 'info',
      message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Decrementing order quantity...', 'lasntgadmin')
    });
    props.setOrderQuantity(updatedQuantity);
    const decrementOrderQuantityRequest = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getUpdateOrderRequest)(order.id, nonce, {
    ...
    const orderRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()(decrementOrderQuantityRequest);
    setNotice({
      status: 'success',
      message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Decremented order quantity.', 'lasntgadmin')
    });
  }
  async function incrementProductStock() {
    if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(order)) {
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Incrementing course spaces...', 'lasntgadmin')
      });
      const incrementProductStockQuantityRequest = (0,_product_utils__WEBPACK_IMPORTED_MODULE_5__.getUpdateProductRequest)(product.id, nonce, {
        stock_quantity: product.stock_quantity + 1,
        stock_status: 'instock' // instock, onbackorder, outofstock
      });
      const productRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()(incrementProductStockQuantityRequest);
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Incremented course spaces.', 'lasntgadmin')
      });
    }
  }
  ...
  async function handleResetAttendee(e) {
    e.preventDefault();
    try {
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default().createNonceMiddleware(props.nonce));

      /**
       * When saved attendee
       */
      if (!(0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNil)(attendee) && (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isAttendeeLoadedViaProps)(attendee)) {
        // Enrolment log entry
        const logEntry = {
          ...
          status: (0,_enrolment_log_utils__WEBPACK_IMPORTED_MODULE_10__.getRemovedEnrolmentStatus)(),
          // canceled status
          comment: ''
        };
        ...
        if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(order)) {
          logEntry.status = (0,_enrolment_log_utils__WEBPACK_IMPORTED_MODULE_10__.getCanceledEnrolmentStatus)();
          logEntry.comment = prompt("Please provide a reason for the cancellation?");
          if ((0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNull)(logEntry.comment) || '' === logEntry.comment) {
            setNotice({
              status: 'error',
              message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('A reason is required when resetting an attendee.', 'lasntgadmin')
            });
            return;
          }
        }
        ...
        setNotice({
          status: 'info',
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Updating enrolment log.', 'lasntgadmin')
        });

        // Update enrolment log
        const updateEnrolmentLogRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_6___default()((0,_enrolment_log_utils__WEBPACK_IMPORTED_MODULE_10__.getUpdateEnrolmentLogRequest)(nonce, logEntry));
        setNotice({
          status: 'info',
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Updating metadata.', 'lasntgadmin')
        });
      ...
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Reset attendee.', 'lasntgadmin')
      });
      setLoading(false);
    } catch (e) {
      console.error(e);
  ...
  async function handleRemoveAttendee(e) {
    ...
    try {
      ...
      if (!(0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNil)(attendee) && (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_9__.isAttendeeLoadedViaProps)(attendee)) {
        ...
        if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(order)) {
          ...
          if ((0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNull)(logEntry.comment) || '' === logEntry.comment) {
            setNotice({
              status: 'error',
              message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('A reason is required to remove an attendee.', 'lasntgadmin')
            });
            return;
          }
        }
      ...
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Updating order quantity and course spaces.', 'lasntgadmin')
      });
      ...
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removing attendee.', 'lasntgadmin')
      });
      ...
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Removed attendee.', 'lasntgadmin')
      });
      setLoading(false);
    } catch (e) {
      console.error(e);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "button alt save_order wp-element-button",
    onClick: handleResetAttendee,
    disabled: isResetable
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Reset Attendee', 'lasntgadmin')), "\xA0", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "button alt save_order wp-element-button",
    onClick: handleRemoveAttendee,
    disabled: isRemovable
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Remove Attendee', 'lasntgadmin')), isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null)));
};


/***/ }),

/***/ "./src/attendees-tab/attendee-form-fieldset-fields.js":
/*!************************************************************!*\
  !*** ./src/attendees-tab/attendee-form-fieldset-fields.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _acf_inputs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./acf-inputs */ "./src/attendees-tab/acf-inputs.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _attendee_context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./attendee-context */ "./src/attendees-tab/attendee-context.js");
...
/* harmony import */ var _product_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../product-utils */ "./src/product-utils.js");
...
const AttendeeFormFieldsetFields = props => {
  const attendee = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.AttendeeContext);
  const fields = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.AcfFieldsContext);
  const product = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.ProductContext);
  const index = parseInt(props.index);
  const quantity = parseInt(props.quantity);
  const groupId = parseInt(props.groupId);
  function isFieldDisabled(field, value) {
    if ((0,_product_utils__WEBPACK_IMPORTED_MODULE_9__.isCourseClosed)(product.status) || !(0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNil)(value) && value !== '' && ['department', 'job_title', 'grade'].includes(field.name)) {
      return true;
    }
    return false;
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_form_fieldset_hidden_fields__WEBPACK_IMPORTED_MODULE_5__.HiddenFields, {
    index: index,
    groupId: groupId
  }), (0,lodash__WEBPACK_IMPORTED_MODULE_7__.isArray)(fields) && fields.map(field => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: `attendees[${index}]['${field.prefix}']['${field.name}']`
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "form-field form-row"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
      htmlFor: `attendee[${index}]['${field.key}']`
    }, field.label, !!field.required && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "required"
    }, " *")), field.instructions && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      className: "description"
    }, field.instructions), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_form_fieldset_predictive_search_fields__WEBPACK_IMPORTED_MODULE_6__.PredictiveSearchFields, {
      quantity: quantity,
      index: index,
      field: field,
      onChange: props.setAttendee
    }), field.type === 'text' && field.name !== 'employee_number' && field.name !== 'last_name' && field.name !== 'first_name' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.TextInput, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      placeholder: field.placeholder,
      value: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee),
      maxLength: field.maxlength,
      required: !!field.required,
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee))
    }), field.type === 'email' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.EmailInput, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      placeholder: field.placeholder,
      value: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee),
      ...
      required: !!field.required,
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee))
    }), field.type === 'textarea' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.TextArea, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      value: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee),
      required: !!field.required,
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee))
    }), field.type === 'date_picker' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.DateInput, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      value: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee),
      required: !!field.required,
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee))
    }), field.type === 'true_false' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.TrueFalse, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee)),
      required: !!field.required,
      checked: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee)
    }), field.type === 'checkbox' && field.name === 'course_prerequisites_met' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.CoursePrerequisitesMetCheckbox, {
      id: `attendee[${index}]['${field.key}']`,
      value: product.id,
      ...
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee)),
      required: !!field.required,
      checked: attendee?.acf?.course_prerequisites_met
    }), field.type === 'number' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.NumberInput, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      value: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee),
      required: !!field.required,
      disabled: isFieldDisabled(field, (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee))
    }), field.type === 'select' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_2__.SelectInput, {
      id: `attendee[${index}]['${field.key}']`,
      name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
      required: !!field.required,
      value: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_8__.getAttendeeAcfValueByField)(field, attendee),
...
/***/ "./src/attendees-tab/attendee-form-fieldset-hidden-fields.js":
/*!*******************************************************************!*\
  !*** ./src/attendees-tab/attendee-form-fieldset-hidden-fields.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const HiddenFields = props => {
  const product = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_2__.ProductContext);
  const order = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_2__.OrderContext);
  const attendee = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_2__.AttendeeContext);
  const index = parseInt(props.index);
  const groupId = parseInt(props.groupId);
  function attendeeMetaExists(key, attendee) {
    return attendee && 'meta' in attendee && key in attendee.meta;
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, attendee?.enrolment_log && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: `attendees[${index}]['enrolment_log']['post_id']`,
    value: attendee.enrolment_log.post_id
  }), (attendee?.ID || attendee?.id) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: `attendees[${index}]['id']`,
    value: attendee?.ID || attendee?.id
  }), (attendee?.post_status || attendee?.status) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: `attendees[${index}]['status']`,
    value: attendee?.post_status || attendee?.status
  }), attendeeMetaExists('order_ids', attendee) && attendee?.meta['order_ids'].map(orderId => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    key: orderId,
    type: "hidden",
    name: `attendees[${index}]['meta']['order_ids']`,
    value: orderId
  })), attendeeMetaExists('product_ids', attendee) && attendee?.meta['product_ids'].map(productId => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    key: productId,
    type: "hidden",
    name: `attendees[${index}]['meta']['product_ids']`,
    value: productId
  })), attendeeMetaExists('groups-read', attendee) && attendee?.meta['groups-read'].map(groupId => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    key: groupId,
    type: "hidden",
    name: `attendees[${index}]['meta']['groups-read']`,
    value: groupId
  })), attendee?.acf?.course_prerequisites_met && attendee?.acf?.course_prerequisites_met.map(productId => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    key: productId,
    type: "hidden",
...
/***/ "./src/attendees-tab/attendee-form-fieldset-predictive-search-fields.js":
/*!******************************************************************************!*\
  !*** ./src/attendees-tab/attendee-form-fieldset-predictive-search-fields.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _predictive_search_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./predictive-search-input */ "./src/attendees-tab/predictive-search-input.js");
/* harmony import */ var _attendee_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./attendee-utils */ "./src/attendees-tab/attendee-utils.js");
/* harmony import */ var _attendee_context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./attendee-context */ "./src/attendees-tab/attendee-context.js");
...
const PredictiveSearchFields = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, field.type === 'text' && field.name === 'first_name' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_predictive_search_input__WEBPACK_IMPORTED_MODULE_2__.PredictiveSearchInput, {
    nonce: nonce,
    ...
    name: `attendees[${index}]['${field.prefix}']['${field.name}']`,
    placeholder: field.placeholder,
    defaultValue: (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_3__.getAttendeeAcfValueByField)(field, attendee),
    maxLength: field.maxlength,
    required: !!field.required,
    onChange: handleSelect,
    onInput: handleInput
  }), field.type === 'text' && field.name === 'last_name' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_predictive_search_input__WEBPACK_IMPORTED_MODULE_2__.PredictiveSearchInput, {
    nonce: nonce,
    acfFieldName: field.name,
    ...
    onChange: handleSelect,
    onInput: handleInput
  }), field.type === 'text' && field.name === 'employee_number' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_predictive_search_input__WEBPACK_IMPORTED_MODULE_2__.PredictiveSearchInput, {
    capitalise: true,
    nonce: nonce,
    acfFieldName: field.name,
    id: `attendee[${index}]['${field.key}']`,
...
/***/ "./src/attendees-tab/attendee-form-fieldset.js":
/*!*****************************************************!*\
  !*** ./src/attendees-tab/attendee-form-fieldset.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _attendee_form_fieldset_fields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./attendee-form-fieldset-fields */ "./src/attendees-tab/attendee-form-fieldset-fields.js");
/* harmony import */ var _attendee_form_fieldset_buttons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./attendee-form-fieldset-buttons */ "./src/attendees-tab/attendee-form-fieldset-buttons.js");
/* harmony import */ var _attendee_context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./attendee-context */ "./src/attendees-tab/attendee-context.js");
...
const AttendeeFormFieldset = props => {
  ...
  const groupId = parseInt(props.groupId);
  const nonce = props.nonce;
  const [attendee, setAttendee] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.attendee)) {
      setAttendee(props.attendee);
    }
  }, [props.attendee]);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_context__WEBPACK_IMPORTED_MODULE_4__.AttendeeContext.Provider, {
    value: attendee
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("fieldset", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("legend", null, "Attendee ", index + 1), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_form_fieldset_fields__WEBPACK_IMPORTED_MODULE_2__.AttendeeFormFieldsetFields, {
    groupId: groupId,
    quantity: quantity,
    index: index,
    setAttendee: setAttendee
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_form_fieldset_buttons__WEBPACK_IMPORTED_MODULE_3__.AttendeeFormFieldsetButtons, {
    index: index,
    setAttendee: setAttendee,
    setAttendees: props.setAttendees,
    nonce: nonce,
    quantity: quantity,
    setFormNotice: props.setFormNotice,
...
/***/ "./src/attendees-tab/attendee-form-fieldsets.js":
/*!******************************************************!*\
  !*** ./src/attendees-tab/attendee-form-fieldsets.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AttendeeFormFieldsets: () => (/* binding */ AttendeeFormFieldsets)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
...
const AttendeeFormFieldsets = props => {
  ...
  return attendees.map((attendee, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_form_fieldset__WEBPACK_IMPORTED_MODULE_2__.AttendeeFormFieldset, {
    key: index,
    groupId: groupId,
    quantity: quantity,
    index: index,
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _attendee_form_fieldsets__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./attendee-form-fieldsets */ "./src/attendees-tab/attendee-form-fieldsets.js");
/* harmony import */ var _product_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../product-utils */ "./src/product-utils.js");
/* harmony import */ var _order_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../order-utils */ "./src/order-utils.js");
/* harmony import */ var _attendee_context__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./attendee-context */ "./src/attendees-tab/attendee-context.js");
/* harmony import */ var _fetch_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../fetch-utils */ "./src/fetch-utils.js");
/* harmony import */ var _attendee_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./attendee-utils */ "./src/attendees-tab/attendee-utils.js");
/* harmony import */ var _enrolment_log_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./enrolment-log-utils */ "./src/attendees-tab/enrolment-log-utils.js");
...
const AttendeeForm = props => {
  ...
  const [notice, setNotice] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [isLoading, setLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [attendees, setAttendees] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const [quantity, setQuantity] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(parseInt(props.quantity));
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (Array.isArray(props.attendees)) {
      let accumulator = [];
      for (let i = 0; i < quantity; i++) {
        if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.attendees[i])) {
  ...
  function showDuplicateEmployeeNumberValidationError(quantity, index) {
    if (index !== false) {
      ...
      const validationErrorMsg = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Employee number must be unique.', 'lasntgadmin');
  ...
  function checkForDuplicateEmployeeNumbers(quantity, formData) {
    const indexedEmployeeNumbers = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.extractIndexedEmployeeNumbersFromForm)(quantity, formData);
    const indexOfDuplicateEmployeeNumberField = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.extractLastIndexOfDuplicateEmployeeNumberField)(indexedEmployeeNumbers);
  ...
  async function handleSubmit(e) {
    ...
    for (let index = 0; index < quantity; index++) {
      ...
      const attendeeAcfFieldsReqBody = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.createAttendeeAcfFieldsBatchRequestBody)(index, formData);
      const attendeeAcfFieldsBatchReq = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.createAttendeeBatchRequest)(nonce, index, formData, attendeeAcfFieldsReqBody, orderId);
    ...
    try {
      ...
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updating attendee details...', 'lasntgadmin')
      });
       ...
       */
      const attendeeAcfFieldsBatchRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()((0,_fetch_utils__WEBPACK_IMPORTED_MODULE_10__.wpBatchReq)(attendeeAcfFieldsBatchReqs));
      const validAttendeeIds = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.extractAttendeeIdsFromResponse)(attendeeAcfFieldsBatchRes.responses);
      // Valid attendees are missing additional acf fields from the response.
      const validAttendees = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.extractValidAttendeesFromResponse)(attendeeAcfFieldsBatchRes.responses);
      // Invalid attendees contain additional acf fields in the response.
      const invalidAttendees = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.extractInvalidAttendeesFromResponse)(attendeeAcfFieldsBatchRes.responses);
      if (validAttendees.length) {
        const attendeeAcfFieldsReqBodies = attendeeAcfFieldsBatchReqs.map(req => req.body);
        const updatedAttendeeAcfFieldsReqBodies = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.addIdToValidAttendees)(attendeeAcfFieldsReqBodies, validAttendees);
      ...
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Adding attendees to enrolment log...', 'lasntgadmin')
      });
      let attendeeEnrolmentLogBatchReqs = [];
      for (const attendeeId of validAttendeeIds) {
        const attendeeEnrolmentLogReqBody = (0,_enrolment_log_utils__WEBPACK_IMPORTED_MODULE_12__.createEnrolmentLogBatchRequestBody)(attendeeId, productId, orderId, groupId, (0,_enrolment_log_utils__WEBPACK_IMPORTED_MODULE_12__.getPendingEnrolmentStatus)(), '');
        const attendeeEnrolmentLogBatchReq = (0,_enrolment_log_utils__WEBPACK_IMPORTED_MODULE_12__.createEnrolmentLogBatchRequest)(nonce, attendeeEnrolmentLogReqBody);
       ...
       */
      const attendeeEnrolmentLogBatchRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()((0,_fetch_utils__WEBPACK_IMPORTED_MODULE_10__.wpBatchReq)(attendeeEnrolmentLogBatchReqs));
      // @todo check attendeeEnrolmentLogBatchRes.responses

      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Adding attendees to order...', 'lasntgadmin')
      });
       ...
       * @deprecated
       */
      const orderAttendeeIdsUpdateRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getUpdateShopOrderRequest)(orderId, nonce, {
        meta: {
      ...
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updating attendee meta...', 'lasntgadmin')
      });
      ...
      for (let index = 0; index < quantity; index++) {
         ...
         */
        const attendeeMetaFieldsReqBody = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.createAttendeeMetaFieldsBatchRequestBody)(index, formData, groupId, orderId, productId);
        const attendeeMetaFieldsBatchReq = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_11__.createAttendeeBatchRequest)(nonce, index, formData, attendeeMetaFieldsReqBody, orderId);
       ...
       *  @deprecated
       */
      const attendeeMetaFieldsBatchRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()((0,_fetch_utils__WEBPACK_IMPORTED_MODULE_10__.wpBatchReq)(attendeeMetaFieldsBatchReqs));
      setNotice({
        status: 'info',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updating order status...', 'lasntgadmin')
      });
      const orderRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getUpdateShopOrderRequest)(orderId, nonce, {
        status: (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(order) || (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCancelledOrder)(order) ? (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getPrefixedOrderStatus)(order.status) : (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getPrefixedPendingPaymentStatus)()
      }));
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updated order. Redirecting...', 'lasntgadmin')
      });
  ...
  function isSubmitButtonDisabled() {
    return (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.isCourseClosed)(props.product.status) || isLoading;
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "form-wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_context__WEBPACK_IMPORTED_MODULE_9__.AttendeeFormContext.Provider, {
    value: {
      isLoading
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    className: "panel-wrap woocommerce",
    onSubmit: handleSubmit,
    autocomplete: "off"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    id: "order_data",
    className: "panel woocommerce-order-data"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_context__WEBPACK_IMPORTED_MODULE_9__.ProductContext.Provider, {
    value: props.product
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_context__WEBPACK_IMPORTED_MODULE_9__.OrderContext.Provider, {
    value: order
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_context__WEBPACK_IMPORTED_MODULE_9__.AcfFieldsContext.Provider, {
    value: props.fields
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_context__WEBPACK_IMPORTED_MODULE_9__.AttendeesContext.Provider, {
    value: attendees
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendee_form_fieldsets__WEBPACK_IMPORTED_MODULE_6__.AttendeeFormFieldsets, {
    nonce: nonce,
    groupId: groupId,
    quantity: quantity,
    setAttendees: setAttendees,
    setFormNotice: setNotice,
    setOrderQuantity: setQuantity
  }))))), quantity > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "form-field"
  }, notice && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
    status: notice.status,
    isDismissable: true,
    ...
    type: "submit",
    className: "button alt save_order wp-element-button button-primary",
    name: "save",
    value: "Create",
    disabled: isSubmitButtonDisabled()
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Save attendees', 'lasntgadmin')), isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null)))))));
};


/***/ }),

/***/ "./src/attendees-tab/attendee-utils.js":
/*!*********************************************!*\
  !*** ./src/attendees-tab/attendee-utils.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   createAttendeeAcfFieldsBatchRequestBody: () => (/* binding */ createAttendeeAcfFieldsBatchRequestBody),
...
/* harmony export */   createAttendeeMetaFieldsBatchRequestBody: () => (/* binding */ createAttendeeMetaFieldsBatchRequestBody),
/* harmony export */   createBatchRequest: () => (/* binding */ createBatchRequest),
/* harmony export */   extractAcfFieldValue: () => (/* binding */ extractAcfFieldValue),
/* harmony export */   extractAcfFieldsByAttendeeIndex: () => (/* binding */ extractAcfFieldsByAttendeeIndex),
/* harmony export */   extractAcfInputName: () => (/* binding */ extractAcfInputName),
/* harmony export */   extractAttendeeIdsFromResponse: () => (/* binding */ extractAttendeeIdsFromResponse),
/* harmony export */   extractCoursePrerequisitesMetFieldValues: () => (/* binding */ extractCoursePrerequisitesMetFieldValues),
/* harmony export */   extractIndexedEmployeeNumbersFromForm: () => (/* binding */ extractIndexedEmployeeNumbersFromForm),
/* harmony export */   extractInvalidAttendeesFromResponse: () => (/* binding */ extractInvalidAttendeesFromResponse),
/* harmony export */   extractLastIndexOfDuplicateEmployeeNumberField: () => (/* binding */ extractLastIndexOfDuplicateEmployeeNumberField),
/* harmony export */   extractValidAttendeesFromResponse: () => (/* binding */ extractValidAttendeesFromResponse),
...
/* harmony export */   getAttendeeAcfValueByField: () => (/* binding */ getAttendeeAcfValueByField),
...
/* harmony export */   isAttendeeLoadedViaProps: () => (/* binding */ isAttendeeLoadedViaProps),
/* harmony export */   isAttendeeLoadedViaSearch: () => (/* binding */ isAttendeeLoadedViaSearch),
/* harmony export */   isExistingAttendee: () => (/* binding */ isExistingAttendee),
...
function isAttendeeLoadedViaProps(attendee) {
  if (!(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isNull)(attendee)) {
...
function getAttendeeAcfValueByField(field, attendee) {
  ...
  if ('default_value' in field && (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isString)(field.default_value)) {
...
function filterOrderIdFromAttendeeMeta(orderId, attendeeMeta) {
  if ('order_ids' in attendeeMeta && Array.isArray(attendeeMeta.order_ids)) {
    return [...new Set(attendeeMeta.order_ids.map(Number).filter(id => id !== parseInt(orderId)))];
  }
  return [];
}
...
function filterProductIdFromAttendeeMeta(productId, attendeeMeta) {
  if ('product_ids' in attendeeMeta && Array.isArray(attendeeMeta.product_ids)) {
    return [...new Set(attendeeMeta.product_ids.map(Number).filter(id => id !== parseInt(productId)))];
  }
  return [];
}
...
function extractAcfFieldsByAttendeeIndex(index, formData) {
  ...
  for (const longName of formData.keys()) {
    ...
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isNull)(shortName)) {
      switch (shortName) {
...
function extractCoursePrerequisitesMetFieldValues(index, formData) {
  ...
  const set = new Set([...existingCoursePrerequisitesMetProductIds, ...coursePrerequisitesMetProductIds]);
  return [...set];
}
...
function extractAttendeeIdsFromResponse(attendeeResponses) {
  return [...new Set(attendeeResponses.map(res => Object.hasOwn(res.body, 'id') ? parseInt(res.body.id) : null).filter(Boolean))];
}
...
/***/ "./src/attendees-tab/enrolment-log-utils.js":
/*!**************************************************!*\
  !*** ./src/attendees-tab/enrolment-log-utils.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createEnrolmentLogBatchRequest: () => (/* binding */ createEnrolmentLogBatchRequest),
/* harmony export */   createEnrolmentLogBatchRequestBody: () => (/* binding */ createEnrolmentLogBatchRequestBody),
/* harmony export */   getCanceledEnrolmentStatus: () => (/* binding */ getCanceledEnrolmentStatus),
/* harmony export */   getPendingEnrolmentStatus: () => (/* binding */ getPendingEnrolmentStatus),
/* harmony export */   getPublishedEnrolmentStatus: () => (/* binding */ getPublishedEnrolmentStatus),
/* harmony export */   getRemovedEnrolmentStatus: () => (/* binding */ getRemovedEnrolmentStatus),
/* harmony export */   getUpdateEnrolmentLogRequest: () => (/* binding */ getUpdateEnrolmentLogRequest)
/* harmony export */ });
...
/***/ "./src/attendees-tab/predictive-search-input.js":
/*!******************************************************!*\
  !*** ./src/attendees-tab/predictive-search-input.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const PredictiveSearchInput = props => {
  const attendee = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useContext)(_attendee_context__WEBPACK_IMPORTED_MODULE_6__.AttendeeContext);
  const quantity = props.quantity;
  const textInput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
  const [attendees, setAttendees] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [options, setOptions] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [disabled, setDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [isLoading, setIsLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props?.options)) {
      setIsLoading(false);
      setOptions(props.options);
    }
  }, [props?.options]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props?.defaultValue)) {
  ...
  function handleSearch(e) {
    ...
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(searchText)) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    ...
    onInput: handleInput,
    autocomplete: "off"
  }), disabled && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: props.name,
    defaultValue: props?.defaultValue
  }), showSearchResult() && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.RadioControl, {
    options: options,
    onChange: handleSelect
  }), showSearchButton() && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "button-link",
    disabled: isSearchButtonDisabled(),
    onClick: handleSearch
  }, "Search"), showCancelButton() && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "button-link",
    onClick: handleCancel
  }, "Cancel"), showSpinner() && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Spinner, null));
};


/***/ }),

/***/ "./src/enrolment-tab/group-selector.js":
/*!*********************************************!*\
  !*** ./src/enrolment-tab/group-selector.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const GroupSelector = props => {
  const [groupId, setGroupId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  ...
  const [isDisabled, setIsDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.groupId)) {
      setGroupId(props.groupId);
    }
  }, [props?.groupId]);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.productId)) {
      async function runFetch() {
        try {
          setIsLoading(true);
          _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().createNonceMiddleware(props.nonce));
          const groups = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
          ...
          if (!groups.length) {
            setNotice({
              status: 'warning',
              message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('You are not a member of any groups.', 'lasntgadmin')
            });
          }
          setGroups(groups);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, notice && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
    status: notice.status,
    isDismissable: true,
    onDismiss: () => setNotice(null)
  }, notice.message), isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null), !isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    id: props.id,
...
/***/ "./src/enrolment-tab/order-form.js":
/*!*****************************************!*\
  !*** ./src/enrolment-tab/order-form.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _product_panel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./product-panel */ "./src/enrolment-tab/product-panel.js");
/* harmony import */ var _status_selector__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./status-selector */ "./src/enrolment-tab/status-selector.js");
/* harmony import */ var _order_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../order-utils */ "./src/order-utils.js");
...
const OrderForm = props => {
  ...
  const [isSubmitButtonDisabled, setSubmitButtonDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [status, setStatus] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [buttonText, setButtonText] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("Create enrolment");

  /**
   * Change button text
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(status) && !(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isEmpty)(status)) {
      if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isWaitingStatus)(status)) {
        setButtonText((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Add enrolment to waiting list', 'lasntgadmin'));
      } else {
        if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isDraftStatus)(status)) {
          setButtonText((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Create enrolment', 'lasntgadmin'));
        } else {
          setButtonText((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Update enrolment', 'lasntgadmin'));
        }
      }
    }
  }, [status]);
  ...
  function determineOrderStatusOnSubmit() {
    if (status === (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getDraftStatus)()) {
      return (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getPendingAttendeesStatus)();
    }
    return status;
  }
  function parseFormData(formData) {
    ...
    if (!(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isExistingOrder)(props?.order)) {
      body.line_items = [{
  ...
  async function handleSubmit(e) {
    ...
    const method = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isExistingOrder)(props.order) ? 'PUT' : 'POST';
    try {
      setNotice(null);
      setIsLoading(true);
      setSubmitButtonDisabled(true);
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().createNonceMiddleware(props.nonce));
      const order = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
        path: (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isExistingOrder)(props.order) ? `/wc/v3/orders/${props.order.id}` : `/wc/v3/orders`,
        method,
        data
      });
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updated enrolment. Redirecting...', 'lasntgadmin')
      });
      switch (data.status) {
        case (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getWaitingStatus)():
          document.location.assign(`/wp-admin/edit.php?post_type=shop_order`);
          break;
        case (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getPendingAttendeesStatus)():
          document.location.assign(`/wp-admin/post.php?post=${order.id}&action=edit&tab=attendees`);
          break;
        case (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getPendingPaymentStatus)():
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    ...
    className: "form-wrap"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_product_panel__WEBPACK_IMPORTED_MODULE_6__.ProductPanel, {
    max: 20,
    ...
    disabled: isSubmitButtonDisabled,
    type: "submit",
    className: "button save_order wp-element-button button-primary",
    name: "save",
    value: "Create"
  }, buttonText), isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null)))));
};
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _product_selector__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./product-selector */ "./src/enrolment-tab/product-selector.js");
/* harmony import */ var _group_selector__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./group-selector */ "./src/enrolment-tab/group-selector.js");
/* harmony import */ var _product_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../product-utils */ "./src/product-utils.js");
/* harmony import */ var _order_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../order-utils */ "./src/order-utils.js");
...
const ProductPanel = props => {
  const [remainingGroupQuota, setRemainingGroupQuota] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [groupQuota, setGroupQuota] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [notice, setNotice] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [price, setPrice] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(0);
  const [quantity, setQuantity] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(0);
  ...
  const [spaces, setSpaces] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [productId, setProductId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [groupId, setGroupId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(""); // empty string when none selected else a number
  const [product, setProduct] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [isQuantityInputDisabled, setQuantityInputDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [isProductDropdownDisabled, setProductDropdownDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [isGroupDropdownDisabled, setGroupDropdownDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [isPriceInfoVisible, setPriceInfoVisible] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [isLoading, setLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(productId) && products?.length > 0) {
      const product = (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.findProductById)(productId, products);
      reset();
      setProduct(product);
    }
  }, [productId]);
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(product)) {
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(quantity) && (0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(spaces)) {
      if (!(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(props.order) && !(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCancelledOrder)(props.order)) {
        if (quantity > spaces && quantity > props.reservedStock) {
          props.setStatus((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getWaitingStatus)());
        } else {
          if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isWaitingStatus)(props.order.status)) {
            props.setStatus((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getDraftStatus)());
          } else {
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(groupId) && (0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(productId) && (0,lodash__WEBPACK_IMPORTED_MODULE_9__.isObject)(product)) {
      if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isExistingOrder)(props.order)) {
        const lineItem = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getLineItemByProductId)(product.id, props.order);
      ...
      if (!(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(props.order) && !(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCancelledOrder)(props.order)) {
        if (isGroupSelected(groupId) && !(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(product) && !(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(productId)) {
          const quota = (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.findGroupQuota)(groupId, (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.findGroupQuotas)(product.meta_data));
          if (isNaN(quota) || (0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(quota) || quota === '') {
            setSpaces((0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.calculateAvailableSpaces)(product.stock_quantity || product.quantity, quota, (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.getReservedStockQuantity)(product)));
            setGroupQuota(null);
          } else {
            setSpaces(null);
            /**
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(groupQuota) && isGroupSelected(groupId) && !(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(product) && !(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(productId)) {
      async function calculateRemainingQuota(productId, groupId) {
        ...
        try {
          _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().createNonceMiddleware(props.nonce));
          const totalAttendees = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(remainingGroupQuota)) {
      const availableSpaces = (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.calculateAvailableSpaces)(product.stock_quantity || product.quantity, remainingGroupQuota, (0,_product_utils__WEBPACK_IMPORTED_MODULE_7__.getReservedStockQuantity)(product));
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(spaces)) {
      if (!(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCompletedOrder)(props.order) && !(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isCancelledOrder)(props.order)) {
        let msg = '';
        if (spaces < 1) {
          msg += (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('No spaces available. ', 'lasntgadmin');
        } else {
          if (spaces < quantity && props.reservedStock < quantity) {
            props.setStatus("waiting-list");
          }
          msg += (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._n)('%s space available. ', '%s spaces available. ', spaces, 'lasntgadmin'), spaces);
        }
        if (props.reservedStock > 0) {
          msg += (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._n)('%s space is temporarily reserved for this order. ', '%s spaces are temporarily reserved for this order. ', parseInt(props.reservedStock), 'lasntgadmin'), props.reservedStock);
        }
        setNotice({
  ...
  function isGroupSelected(groupId) {
    return !(0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNil)(groupId) && groupId !== '';
  }
  ...
  function handleFetchedGroups(groups) {
    const orderMeta = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.findOrderMetaByKey)('groups-read', props.order.meta_data);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, notice && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
    ...
    htmlFor: "product"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Course', 'lasntgadmin'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "required"
  }, " *")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_product_selector__WEBPACK_IMPORTED_MODULE_5__.ProductSelector, {
    id: "product",
    name: "product",
    ...
    products: products
  })), props?.lineItem?.id && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: "line_item_id",
    ...
    htmlFor: "order_group"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Group', 'lasntgadmin'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "required"
  }, " *")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_group_selector__WEBPACK_IMPORTED_MODULE_6__.GroupSelector, {
    productId: productId,
  ...
  })), isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null), !isLoading && isPriceInfoVisible && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "form-field form-row"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    htmlFor: "price"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Price', 'lasntgadmin')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    id: "price",
    disabled: true,
    placeholder: "0",
    ...
    htmlFor: "quantity"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Quantity', 'lasntgadmin'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "required"
  }, " *")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    id: "quantity",
    ...
    htmlFor: "total"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Total', 'lasntgadmin')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    id: "total",
    type: "number",
    disabled: true,
...
/***/ "./src/enrolment-tab/product-selector.js":
/*!***********************************************!*\
  !*** ./src/enrolment-tab/product-selector.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const ProductSelector = props => {
  const [isLoading, setIsLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [productId, setProductId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  const [isDisabled, setIsDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.disabled)) {
      setIsDisabled(props.disabled);
    ...
    async function runFetch() {
      try {
        ...
        if (!result.length) {
          props.setNotice({
            status: 'error',
            message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('No courses are available.', 'lasntgadmin')
          });
        }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, null), !isLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    id: props.id,
    disabled: (0,lodash__WEBPACK_IMPORTED_MODULE_5__.isBoolean)(props.disabled) ? props.disabled : isDisabled,
    required: true,
    onChange: props.onChange,
    value: productId
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    disabled: true,
    value: ""
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Please select', 'lasntgadmin')), props.products.map(product => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
...
const StatusSelector = props => {
  const [statuses, setStatuses] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
  const [notice, setNotice] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [isLoading, setIsLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
  const [isDisabled, setIsDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {}, [props.status]);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    async function runFetch() {
      try {
        setIsLoading(true);
        _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default().createNonceMiddleware(props.nonce));
        const statuses = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
        ...
        if (!statuses.length) {
          setNotice({
            status: 'warning',
            message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Failed fetching enrolment statuses.', 'lasntgadmin')
          });
        }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, notice && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
    ...
    value: props.status,
    onChange: handleChange
  }, (0,_order_utils_js__WEBPACK_IMPORTED_MODULE_5__.isDraftStatus)(props.status) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    value: "auto-draft"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Draft', 'lasntgadmin')), !(0,_order_utils_js__WEBPACK_IMPORTED_MODULE_5__.isDraftStatus)(props.status) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    disabled: true,
    value: ""
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Please select', 'lasntgadmin')), statuses.map(status => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: status.id,
    value: status.id
  }, status.name))), !(0,_order_utils_js__WEBPACK_IMPORTED_MODULE_5__.isDraftStatus)(props.status) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
    name: props.name,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   wpBatchReq: () => (/* binding */ wpBatchReq)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   filterAttendeeIdFromOrderMeta: () => (/* binding */ filterAttendeeIdFromOrderMeta),
/* harmony export */   filterItemFromOrderMeta: () => (/* binding */ filterItemFromOrderMeta),
...
/* harmony export */   getPendingAttendeesStatus: () => (/* binding */ getPendingAttendeesStatus),
/* harmony export */   getPendingPaymentStatus: () => (/* binding */ getPendingPaymentStatus),
/* harmony export */   getPrefixedOrderStatus: () => (/* binding */ getPrefixedOrderStatus),
/* harmony export */   getPrefixedPendingPaymentStatus: () => (/* binding */ getPrefixedPendingPaymentStatus),
...
/* harmony export */   isCancelledOrder: () => (/* binding */ isCancelledOrder),
/* harmony export */   isCancelledStatus: () => (/* binding */ isCancelledStatus),
/* harmony export */   isCompletedOrder: () => (/* binding */ isCompletedOrder),
/* harmony export */   isCompletedStatus: () => (/* binding */ isCompletedStatus),
...
/* harmony export */   isItemInOrderMeta: () => (/* binding */ isItemInOrderMeta),
/* harmony export */   isPendingAttendeesStatus: () => (/* binding */ isPendingAttendeesStatus),
/* harmony export */   isPendingPaymentStatus: () => (/* binding */ isPendingPaymentStatus),
...
function filterAttendeeIdFromOrderMeta(attendeeId, orderMeta) {
  ...
  if (attendeeIds !== undefined) {
    ...
    return [...new Set(attendeeIdsOrderMeta.map(meta => meta.value).map(Number).filter(id => parseInt(id) !== parseInt(attendeeId)))];
  }
  return [];
}
...
/* harmony export */   getReservedStockQuantity: () => (/* binding */ getReservedStockQuantity),
/* harmony export */   getUpdateProductRequest: () => (/* binding */ getUpdateProductRequest),
...
window.addEventListener('load', function (e) {
  ...
  if (domElement) {
    const uiElement = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_enrolment_tab_order_form__WEBPACK_IMPORTED_MODULE_1__.OrderForm, {
...
window.addEventListener('load', function (e) {
  ...
  if (domElement) {
    const uiElement = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_attendees_tab_attendee_form__WEBPACK_IMPORTED_MODULE_2__.AttendeeForm, {
