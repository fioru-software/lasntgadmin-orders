...
const AttendeeFormFieldsetButtons = props => {
  ...
  async function incrementProductStock() {
    if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isPaidOrder)(order)) {
      setNotice({
        status: 'info',
...
const HiddenFields = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (attendee?.ID || attendee?.id) && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "hidden",
...
/* harmony import */ var _attendee_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./attendee-utils */ "./src/attendees-tab/attendee-utils.js");
...
const AttendeeForm = props => {
  ...
  function checkForDuplicateEmployeeNumbers(quantity, formData) {
    const indexedEmployeeNumbers = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.extractIndexedEmployeeNumbersFromForm)(quantity, formData);
    const indexOfDuplicateEmployeeNumberField = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.extractLastIndexOfDuplicateEmployeeNumberField)(indexedEmployeeNumbers);
  ...
  async function handleSubmit(e) {
    ...
    for (let index = 0; index < quantity; index++) {
      // acf fields only
      const attendeeAcfFieldsReqBody = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.createAttendeeAcfFieldsBatchRequestBody)(index, formData);
      const attendeeAcfFieldsBatchReq = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.createAttendeeBatchRequest)(nonce, index, formData, attendeeAcfFieldsReqBody, orderId);
      attendeeAcfFieldsBatchReqs.push(attendeeAcfFieldsBatchReq);

      // meta fields only
      const attendeeMetaFieldsReqBody = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.createAttendeeMetaFieldsBatchRequestBody)(index, formData, groupId, orderId, productId);
      const attendeeMetaFieldsBatchReq = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.createAttendeeBatchRequest)(nonce, index, formData, attendeeMetaFieldsReqBody, orderId);
      attendeeMetaFieldsBatchReqs.push(attendeeMetaFieldsBatchReq);

      // acf + meta fields
      const attendeeBatchReqBody = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.createAttendeeBatchRequestBody)(attendeeAcfFieldsReqBody, attendeeMetaFieldsReqBody);
      const attendeeBatchReq = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.createAttendeeBatchRequest)(nonce, index, formData, attendeeBatchReqBody, orderId);
    ...
    try {
       ...
       */
      const attendeeAcfFieldsBatchRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
        path: `/batch/v1`,
        method: 'POST',
        data: {
      ...
      const validAttendeeIds = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.extractAttendeeIdsFromResponse)(attendeeAcfFieldsBatchRes.responses);
      // Valid attendees are missing additional acf fields from the response.
      const validAttendees = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.extractValidAttendeesFromResponse)(attendeeAcfFieldsBatchRes.responses);
      // Invalid attendees contain additional acf fields in the response.
      const invalidAttendees = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.extractInvalidAttendeesFromResponse)(attendeeAcfFieldsBatchRes.responses);
      if (validAttendees.length) {
        const attendeeReqBodies = attendeeBatchReqs.map(req => req.body);
        const updatedAttendeeReqBodies = (0,_attendee_utils__WEBPACK_IMPORTED_MODULE_10__.addIdToValidAttendees)(attendeeReqBodies, validAttendees);
       ...
       *  - groups-read 
       */
      const attendeeMetaFieldsBatchRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
        path: `/batch/v1`,
        method: 'POST',
        data: {
      ...
      const orderRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getUpdateShopOrderRequest)(orderId, nonce, {
        status: (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isPaidOrder)(order) || (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isWaitingOrder)(order) ? `wc-${order.status}` : 'wc-pending'
      }));
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updated order. Redirecting...', 'lasntgadmin')
      });
      document.location.assign((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isWaitingOrder)(order) ? `/wp-admin/edit.php?post_type=shop_order` : `/wp-admin/post.php?post=${orderId}&action=edit&tab=payment`);
    } catch (e) {
      console.error(e);
      setNotice({
        status: 'error',
...
const OrderForm = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {}, [props?.order]);

  /**
   * Set initial button text
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props?.status)) {
      setStatus(props.status);
      if (!(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isDraftStatus)(props.status)) {
  ...
  function determineStatus() {
    ...
    if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isWaitingStatus)(status)) {
      return (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getWaitingStatus)();
    }
    return status;
  }
  function parseFormData(formData) {
    ...
    if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isExistingOrder)(props?.order)) {
      const lineItem = (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.getLineItemByProductId)(body.line_items[0].product_id, props.order);
      body.line_items = [{
        ...body.line_items[0],
        ...{
          id: lineItem.id,
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setNotice({
        status: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updated enrolment. Redirecting to attendees tab...', 'lasntgadmin')
      });

      // if the order is being moved from waiting-list to pending 
      if ((0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isWaitingStatus)(oldStatus) && (0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isPendingPaymentStatus)(status)) {
        setNotice({
          status: 'success',
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updated enrolment. Client will be notified.', 'lasntgadmin')
        });
        setIsLoading(false);
      } else {
        setNotice({
          status: 'success',
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Updated enrolment. Redirecting...', 'lastngadmin')
        });
      }
      switch (order.status) {
...
const ProductPanel = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(quantity) && (0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(spaces)) {
      if (!(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isPaidOrder)(props.order)) {
        if (quantity > spaces) {
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,lodash__WEBPACK_IMPORTED_MODULE_9__.isNumber)(spaces) && !(0,_order_utils__WEBPACK_IMPORTED_MODULE_8__.isPaidOrder)(props.order)) {
      if (spaces < 1) {
        props.setStatus("waiting-list");
        setNotice({
          status: "error",
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('No spaces available', 'lasntgadmin')
        });
      } else {
        props.setStatus(props.order.status);
        setNotice({
          status: parseInt(spaces) > 0 ? "info" : "warning",
          message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__._n)('%s space available.', '%s spaces available.', spaces, 'lasntgadmin'), spaces)
        });
      }
      setPriceInfoVisible(true);
      setLoading(false);
