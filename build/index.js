...
const AttendeeFields = props => {
  ...
  // @todo remove
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.order)) {
  ...
  // @todo remove
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_5__.isNil)(props.product)) {
  ...
  async function handleRemoveAttendee(e) {
    ...
    try {
      ...
      const updateAttendeeRequestBody = (0,_order_utils__WEBPACK_IMPORTED_MODULE_7__.getUpdateAttendeeRequestBody)(props.order.id, attendee.ID, props.nonce, {
        meta: {
          product_ids: [...new Set(attendee?.meta?.product_ids.map(Number).filter(Number).filter(product_id => product_id !== parseInt(props.productId)))],
          order_ids: [...new Set(attendee?.meta?.order_ids.map(Number).filter(Number).filter(order_id => order_id !== parseInt(props.order.id)))]
        }
      });
      ...
      const updateOrderRequestBody = (0,_order_utils__WEBPACK_IMPORTED_MODULE_7__.getUpdateOrderRequestBody)(props.order.id, props.nonce, {
        ...
        meta: {
          attendee_ids: [...new Set(props?.order?.meta_data.filter(meta => meta.key === 'attendee_ids').map(meta => parseInt(meta.value)).filter(attendee_id => attendee_id !== parseInt(attendee.ID)))]
        }
      });
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Reset Attendee', 'lasntgadmin'))), readOnly && props.order.meta_data.filter(meta => meta.key === 'attendee_ids').map(meta => meta.value).map(Number).includes(attendee.ID) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "form-field"
...
const Attendees = props => {
   ...
   */
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!(0,lodash__WEBPACK_IMPORTED_MODULE_7__.isNil)(props.order)) {
      console.log(props.order);
    }
  }, [props.order]);
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default().createNonceMiddleware(props.nonce));
      const orderAttendeeIdsUpdateRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()((0,_order_utils__WEBPACK_IMPORTED_MODULE_5__.getUpdateOrderRequestBody)(props.order.id, props.nonce, {
        meta: {
      ...
      const orderRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()((0,_order_utils__WEBPACK_IMPORTED_MODULE_5__.getUpdateOrderRequestBody)(props.order.id, props.nonce, {
