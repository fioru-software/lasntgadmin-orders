...
/* harmony export */   "CoursePrerequisitesMetCheckBox": function() { return /* binding */ CoursePrerequisitesMetCheckBox; },
...
const AttendeeFields = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)(`Attendee ${props.index + 1}`, 'lasntgadmin')), (props?.attendee?.ID || attendee?.id) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }), field.type === 'textarea' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_3__.TextArea, {
      id: field.key,
      readOnly: readOnly,
      disabled: props.disabled,
      name: `attendees[${props.index}]['${field.prefix}']['${field.name}']`,
      ...
      required: !!field.required,
      handleFocus: handleAttendeeSearchFocus
    }), field.type === 'true_false' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_3__.TrueFalse, {
      id: field.key,
      readOnly: readOnly,
      name: `attendees[${props.index}]['${field.prefix}']['${field.name}']`,
      disabled: props.disabled,
      ...
      defaultValue: attendee?.acf[field.name] || field.default_value,
      handleFocus: handleAttendeeSearchFocus
    }), field.type === 'checkbox' && field.name === 'course_prerequisites_met' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_acf_inputs__WEBPACK_IMPORTED_MODULE_3__.CoursePrerequisitesMetCheckBox, {
      id: field.key,
      readOnly: readOnly,
  ...
  }), readOnly && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "form-field"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    type: "button",
    class: "button alt save_order wp-element-button",
    onClick: handleResetAttendee
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Reset Attendee', 'lasntgadmin'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null));
};
...
const Attendees = props => {
    ...
    return {
      ...
      body: {
        ...
        meta: {
          ...
          'product_ids': [...new Set(formData.getAll(`attendees[${index}]['meta']['product_ids']`).map(Number).filter(Number).concat(parseInt(props.productId)))]
        },
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default().createNonceMiddleware(props.nonce));
      const orderAttendeeIdsUpdateRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()(createUpdateOrderAttendeeIdsRequestBody(props.order.id, attendeeIds));
      ...
      const orderRes = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()(createUpdateOrderStatusRequestBody(props.order.id, (0,_order_utils__WEBPACK_IMPORTED_MODULE_5__.hasAttendees)(props.order) || (0,_order_utils__WEBPACK_IMPORTED_MODULE_5__.isWaitingOrder)(props.order) ? `wc-${props.order.status}` : 'wc-pending'));
      setNotice({
        status: 'success',
...
/* harmony export */   "getAttendeesStatus": function() { return /* binding */ getAttendeesStatus; },
...
/* harmony export */   "getPendingStatus": function() { return /* binding */ getPendingStatus; },
