...
const AttendeeFields = props => {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Reset Attendee', 'lasntgadmin'))), readOnly && props.order.meta_data.filter(meta => meta.key === 'attendee_ids').map(meta => meta.value).map(Number).includes(attendee.ID) && props?.order?.line_items[0]?.quantity > 1 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "form-field"
...
const Attendees = props => {
  ...
  const [isRemoveButtonDisabled, setRemoveButtonDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
  const [isLoading, setIsLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (props?.quantity > 0) {
